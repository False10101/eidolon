...
export default function home() {
    ...
    return (
    <>
      {/* This container is now hidden by default. The CSS block below will only
        show it on screens wider than 1150px.
      */}
      <div className="hidden h-full w-full dashboard-container">
        
        {/* --- Main Content (80%) --- */}
        <div className="w-[80%] h-full flex flex-col px-8 main-content" style={{ backgroundImage: 'linear-gradient(to bottom, #000000 0%, #1A2242 70%)' }}>
          ...
          <div className="welcome-section h-[25%] flex flex-col pt-6">
            ...
            <div className="stat-list mt-4 grid grid-cols-4 gap-4 px-3 h-max">
              
              {/* --- Stat Cards --- */}
              <div className="total-token-sent-card border-[1px] border-white/[0.1] rounded-[12px] bg-[#060a21] flex flex-col p-8" style={{ boxShadow: 'inset 0 0px 32px rgba(0, 0, 0, 1), 0 8px 32px rgba(31, 38, 135, 0.42)' }} >
              ...
              <div className="total-token-recieved-card border-[1px] border-white/[0.1] rounded-[12px] bg-[#060a21] flex flex-col p-8" style={{ boxShadow: 'inset 0 0px 32px rgba(0, 0, 0, 1), 0 8px 32px rgba(31, 38, 135, 0.42)' }} >
                  <div className='flex flex-col m-auto justify-between w-full h-full'>
                      <div className='flex flex-row w-full'>
                          <div className='flex flex-col items-start justify-center gap-y-2 '>
              ...
              <div className="api-calls-card border-[1px] border-white/[0.1] rounded-[12px] bg-[#060a21] flex flex-col p-8" style={{ boxShadow: 'inset 0 0px 32px rgba(0, 0, 0, 1), 0 8px 32px rgba(31, 38, 135, 0.42)' }} >
                  <div className='flex flex-col m-auto justify-between w-full h-full'>
                      <div className='flex flex-row w-full'>
                          <div className='flex flex-col items-start justify-center gap-y-2 '>
              ...
              <div className="total-cost-card border-[1px] border-white/[0.1] rounded-[12px] bg-[#060a21] flex flex-col p-8" style={{ boxShadow: 'inset 0 0px 32px rgba(0, 0, 0, 1), 0 8px 32px rgba(31, 38, 135, 0.42)' }} >
                  <div className='flex flex-col m-auto justify-between w-full h-full'>
                      <div className='flex flex-row w-full'>
                          <div className='flex flex-col items-start justify-center gap-y-2 '>
          ...
          <div className="navigation-section h-[30%]">
            <div className='flex flex-col h-full pt-6'>
              ...
              <div className='navigation-list grid grid-cols-6 justify-items-center gap-x-12 px-12 mx-3 mt-4 border-[1px] border-[#395CAE]/[55%] rounded-xl h-max bg-[#000000]/[10%] py-5 content-center'>
                {/* --- Navigation Buttons --- */}
                <button onClick={()=>{router.push('/document');}} className='group grid h-[80%] items-center justify-center p-1'>
                    ...
                    <div className='font-bold mx-auto text-center mt-2 group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>Document</div>
                    <div className='font-bold text-center mx-auto mb-1 group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>Generator</div>
                    <div><div className='text-sm text-white/[50%] text-wrap w-[80%] mx-auto text-center group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>Create professional documents</div></div>
                </button>
                <button onClick={()=>{router.push('/note');}} className='group grid h-[80%] items-center justify-center p-1'>
                    ...
                    <div className='font-bold text-center mx-auto mt-2 group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>Inclass</div>
                    <div className='font-bold text-center mx-auto mb-1 group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>Notes</div>
                    <div><div className='text-sm text-white/[50%] text-wrap w-[80%] mx-auto text-center group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>Transcribe and Organize Notes</div></div>
                </button>
                <button onClick={() => { router.push('/textbook-explainer'); }} className='group grid h-[80%] items-center justify-center p-1'>
                    ...
                    <div className='font-bold mx-auto text-center mt-2 group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>Textbook</div>
                ...
                <button className=' group grid h-[80%] items-center justify-center p-1'>
                    ...
                    <div className='font-bold mx-auto text-center mt-2 group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>TTS with</div>
                ...
                <button className='group grid h-[80%] items-center justify-center p-1'>
                    ...
                    <div className='font-bold text-center mx-auto mt-2 group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>Image</div>
                    <div className='font-bold text-center mx-auto mb-1 group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>Generator</div>
                ...
                <button className='group grid h-[80%] items-center justify-center p-1'>
                    ...
                    <div className='font-bold text-center mx-auto mt-2 group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>Chat with</div>
                    <div className='font-bold text-center mx-auto mb-1 group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>Ai</div>
                    <div><div className='text-sm text-white/[50%] text-wrap w-[80%] mx-auto text-center group-hover:text-shadow-[0_0px_10px_rgba(162,218,255,1)]'>Ask anything to Ai Chatbot</div></div>
                </button>
              </div>
            </div>
          </div>
          ...
          {/* --- Activity Section --- */}
          <div className="activity-section  flex-grow mx-3 py-4 flex flex-col">
            <div className='flex flex-col h-full overflow-hidden'>
              <div className='text-white font-bold text-xl'>Recent Activity</div>
              <div className="overflow-x-auto">
                <div className='flex flex-col flex-grow my-3 border-2 border-white/[10%] rounded-xl bg-[#0f142e]'>
                  ...
                  <div className='flex flex-col w-full overflow-y-auto h-[30vh] '>
                      ...
                      <div className={`flex px-7 w-[30%] font-bold items-center ${activity.type === "Document" ? "text-[#3366FF]": 
                      ...
                      <div className='flex px-7 w-[20%] items-center'>{activity.date}</div>
                      <div className='flex px-7 w-[18.5%] justify-center text-[#00CED1] hover:underline items-center'><EyeIcon className='size-6 text-[#00CED1] mr-2'/> View More</div>
                          </div>
                      ))}
                  </div>
                </div>
        ...
        <div className="status-bar w-[20%] h-full bg-[#000000]/[0.3] flex flex-col px-5 py-3">
          ...
          <div className='api-status-card rounded-xl flex h-auto my-6 pb-2 bg-[#20232F]/[64%]'>
            <div className='flex flex-col space-y-2 mx-4 h-max my-auto w-full'>
              ...
              {dummyStatusData.map((api, index) => (
                <div key={index} className="text-sm text-white/[70%] w-full flex justify-between items-center">
          ...
          <div className='monthly-usage-card flex h-auto bg-[#20232F]/[64%] rounded-xl'>
            <div className='flex flex-col space-y-2 mx-4 h-max my-auto w-full'>
              <h1 className='text-xl font-extrabold w-full'>Monthly Usage</h1>
              {monthlyUsageData.map((api, index) => (
                <div key={index} className="text-sm text-white/[70%] w-full flex flex-col justify-between items-center">
                  <div className='flex flex-row w-full pb-0.5 pr-2'> 
                    <div className="flex-grow">{api.type}</div>
                    <div className='flex'>{api.totalUsage}/<span className={`text-[${api.color}]`}>∞</span></div>
                  </div>
                  <div className="w-full">
                    <ProgressBar completed={parseInt(api.totalUsage)} maxCompleted={parseInt(api.totalUsage)} bgColor={api.color} baseBgColor="#1E293B" height="0.39em" width="100%" labelAlignment="outside" labelSize="0px" />
                  </div>
                </div>
              ))}
            </div>
          </div>
          <div className='monthly-token-usage-card flex h-auto my-6 bg-[#20232F]/[64%] rounded-xl'>
            <div className='flex flex-col space-y-2 mx-4 h-max my-auto w-full'>
              ...
              {monthlyTokenUsageData.map((api, index) => (
                <div key={index} className="text-sm text-white/[70%] w-full flex flex-col justify-between items-center">
                  ...
                  <div className="w-full">
                    <ProgressBar completed={parseInt(api.totalTokenUsage)} maxCompleted={parseInt(api.totalTokenUsage)} bgColor={api.color} baseBgColor="#1E293B" height="0.39em" width="100%" labelAlignment="outside" labelSize="0px" />
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* --- This message is now VISIBLE by default --- */}
      <div className="flex mobile-message">
          <p>This dashboard is not available on mobile.</p>
          <p>Please use a tablet (in landscape view) or a desktop device.</p>
      </div>
      ...
      <style jsx global>{`
          .mobile-message {
              ...
              height: 100vh;
              width: 100vw;
              background-image: linear-gradient(to bottom, #000000 0%, #1A2242 70%);
              font-size: 1.25rem;
              padding: 1rem;
              color: white;
          }

          /* This is the only media query. It shows the dashboard and hides the message
             when the screen is wider than 1150px. */
