...
// ─── Delete modal ──────────────────────────────────────────────────────────────
function DeleteModal({ balance, onConfirm, onClose, loading }) {
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-[#0c0c0e] font-sans text-sm text-[#e8e8ed]">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          {/* Title */}
          <motion.div variants={itemVariants} className="font-serif text-[22px] font-normal tracking-[-0.02em] text-[#e8e8ed] flex-shrink-0">
            Your <span className="text-[#00d4c8]">profile</span>
          </motion.div>
                ...
                <div className="flex items-center gap-4 mb-5">
                  <div className="flex h-14 w-14 flex-shrink-0 rounded-full border border-[rgba(0,212,200,0.2)] overflow-hidden">
                    {profile?.avatar_url ? (
                      ...
                      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-[rgba(0,212,200,0.3)] to-[rgba(0,212,200,0.08)] font-serif text-[22px] text-[#00d4c8]">
                    ...
                    {editingName ? (
                      <div className="flex items-center gap-2 mb-1">
                        <input
                          ...
                          disabled={nameSaving}
                          className="rounded-lg border border-[rgba(0,212,200,0.35)] bg-[#18181f] px-2.5 py-1.5 text-[14px] font-medium text-[#e8e8ed] outline-none w-[180px] disabled:opacity-50"
                        />
                        <button onClick={handleSaveName} disabled={nameSaving}
                          className="flex items-center gap-1.5 rounded-lg bg-[#00d4c8] px-2.5 py-1.5 text-[11px] font-medium text-[#0c0c0e] transition-opacity hover:opacity-90 disabled:opacity-50">
                      ...
                      <div className="flex items-center gap-2 mb-0.5">
                        <span className="text-[15px] font-medium text-[#e8e8ed] truncate">{profile?.username}</span>
                        <button
