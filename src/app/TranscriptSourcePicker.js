    ...
    return (
        <>
            ...
            <div
                ...
                className="relative flex flex-shrink-0 cursor-pointer items-center gap-5 overflow-hidden rounded-xl border-[1.5px] border-dashed px-5 py-3.5 transition-all duration-200 border-[var(--border)] hover:border-[rgba(0,212,200,0.28)] hover:bg-[rgba(0,212,200,0.02)]"
            >
                ...
                {!mode && (
                    <>
                        <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-[10px] border border-[var(--border)] bg-[var(--surface-raised)]">
                            <svg viewBox="0 0 24 24" className="h-5 w-5 fill-none stroke-[1.6] stroke-[var(--fg-3)]">
                        ...
                        <div className="flex-1">
                            <div className="text-[14px] font-medium text-[var(--fg)]">{t('chooseTranscriptSource')}</div>
                            <div className="mt-0.5 text-[12px] text-[var(--fg-3)]">{t('uploadTxtOrPick')}</div>
                        </div>
                        <span className="rounded-md border border-[var(--border)] bg-[var(--surface-raised)] px-2 py-0.5 font-mono text-[10.5px] text-[var(--fg-3)] uppercase">.txt</span>
                    </>
                )}
                    ...
                    <>
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="mt-0.5 text-[12px] text-[var(--fg-3)]">
                                {t('inAppTranscript')}{formatDuration(selectedTranscript.duration) ? ` · ${formatDuration(selectedTranscript.duration)}` : ''}
                            </div>
                        </div>
                        <button onClick={clearSelection}
                            className="flex-shrink-0 flex items-center gap-1.5 rounded-lg border border-[var(--border)] bg-[var(--surface-raised)] px-3 py-1.5 text-[12px] text-[var(--fg-3)] transition-all hover:border-[rgba(239,68,68,0.3)] hover:text-[#ef4444]">
                ...
                {open && (
                    ...
                    >
                        <motion.div
                            ...
                            className="w-full max-w-[720px] mx-6 rounded-2xl border border-[var(--border-strong)] bg-[var(--surface)] shadow-2xl overflow-hidden surface"
                        >
                            {/* Header */}
                            <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--border)] bg-[var(--surface-raised)]">
                                <div>
                                    <div className="text-[14px] font-medium text-[var(--fg)]">{t('chooseTranscriptSource')}</div>
                                    <div className="mt-0.5 text-[12px] text-[var(--fg-3)]">{t('uploadFileOrSelectExisting')}</div>
                                </div>
                                <button
                            ...
                            {/* Two columns */}
                            <div className="grid grid-cols-2 divide-x divide-[var(--border)]" style={{ minHeight: 320 }}>

                                {/* LEFT — Upload */}
                                <div className="flex flex-col p-5">
                                    <div className="mb-3 text-[10px] uppercase tracking-[0.08em] text-[var(--fg-3)] select-none">{t('uploadFileLabel')}</div>
                                    <div
                      ...
                      ${isDragging
                                                ...
                                                : 'border-[var(--border)] hover:border-[rgba(0,212,200,0.3)] hover:bg-[rgba(0,212,200,0.02)]'}`}
                                    >
                                        <div className={`flex h-12 w-12 items-center justify-center rounded-xl border transition-all ${isDragging ? 'border-[rgba(0,212,200,0.2)] bg-[rgba(0,212,200,0.08)]' : 'border-[var(--border)] bg-[var(--surface-raised)]'}`}>
                                            <svg viewBox="0 0 24 24" className={`h-5 w-5 fill-none stroke-[1.6] transition-colors ${isDragging ? 'stroke-[var(--accent)]' : 'stroke-[var(--fg-3)]'}`}>
                                                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
                                                <polyline points="17 8 12 3 7 8" />
                                                <line x1="12" y1="3" x2="12" y2="15" />
                                            </svg>
                                        ...
                                        <div className="text-center">
                                            <div className="text-[13px] font-medium text-[var(--fg)]">{t('dropTxtHere')}</div>
                                            <div className="mt-0.5 text-[12px] text-[var(--fg-3)]">{t('orClickToBrowse')}</div>
                                        </div>
                                        <span className="rounded-md border border-[var(--border)] bg-[var(--surface-raised)] px-2 py-0.5 font-mono text-[10.5px] text-[var(--fg-3)] uppercase">.txt</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col p-5">
                                    <div className="mb-3 text-[10px] uppercase tracking-[0.08em] text-[var(--fg-3)] select-none">{t('pickTranscriptLabel')}</div>
                                    ...
                                    <div className="relative mb-3 flex-shrink-0">
                                        ...
                                        <input
                                            ...
                                            placeholder={t('searchTranscriptsPlaceholder')}
                                    ...
                                    <div
                                        ...
                                        style={{ maxHeight: 220, scrollbarWidth: 'thin', scrollbarColor: 'var(--surface-deep) transparent' }}
                                    >
                                        {loading ? (
                                            ...
                                            <div className="flex items-center justify-center py-8">
                                                <p className="text-[12px] text-[var(--fg-3)]">
                                                    {transcripts.length === 0 ? t('noTranscriptsYetPicker') : t('noResultsFound')}
                                                </p>
                                            </div>
                                        ) : filtered.map((tx) => (
                                            <button
                                                ...
                                                className="group flex w-full items-center gap-3 rounded-lg border border-[var(--border)] bg-[var(--surface-raised)] px-3.5 py-2.5 text-left transition-all duration-100 hover:border-[rgba(0,212,200,0.25)] hover:bg-[rgba(0,212,200,0.03)]"
                                            >
                                                <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg border border-[var(--border)] group-hover:border-[rgba(0,212,200,0.25)] bg-[var(--surface)]">
                                                    <svg viewBox="0 0 24 24" className="stroke-[var(--fg-3)] group-hover:stroke-[var(--accent)]  fill-none stroke-[1.8] transition-colors" style={{ width: 13, height: 13 }}>
                                                        <path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z" />
                                                        <path d="M19 10v2a7 7 0 0 1-14 0v-2" />
                                                    </svg>
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex items-center gap-1.5 mt-0.5">
                                                        {formatDuration(tx.duration) && (
                                                            <>
                                                                <span className="text-[11px] text-[var(--fg-3)]">{formatDuration(tx.duration)}</span>
                                                ...
                                                <svg viewBox="0 0 24 24"
                                                    className="h-3.5 w-3.5 flex-shrink-0 stroke-[var(--fg-3)] fill-none stroke-[1.8] opacity-0 group-hover:opacity-100 transition-opacity">
